...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors duration-200 hover:bg-muted/50 dark:hover:bg-muted/30 data-[state=selected]:bg-muted dark:data-[state=selected]:bg-muted/50",
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      "sticky top-0 z-10 bg-background dark:bg-gray-900",
      className
    )}
    {...props}
  />
